...
de ser siempre el peor`,
    about:`Essa música não começou com uma discussão.
...
`,
    about:`Essa música não nasceu de um momento específico.
Veio de um acúmulo.
...
`,
    about:`Essa música não foi escrita de um ponto de vista único.
...
e não vão me fazer voltar`,
    about:`Essa música acontece em um horário específico.
Depois das duas da manhã.
...
Was yours all along`,
    about:`Durante a gravação dessa música, TRACE evitou regravar vocais muito polidos.
